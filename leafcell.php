...
<div class="text-center" id="planttypeOnionCell">
    <button class="btn btn-primary"   onclick="location.href='onioncell.php';"> Onion Cell </button>
    <button class="btn btn-secondary" id="btnOnionCell"  onclick="location.href='leafcell.php';"  > Leaf Cell </button>
    <button class="btn btn btn-info"  > Other </button>
</div>
...
<div class="row">
        <div class="col-md-4">
            ...
            <div  class="text-center" id="showSubBtnLow40x">
                ...
                <!-- <button class="btn btn-outline-info rounded-circle" onclick="showSubBtnLow10x()" > 10X </button> -->
        ...
        <br>
        <div class="col-md-4">
            <h4 style="text-align: center;"> LEAF CELL IMAGE </h4>
        ...
        <div class="col-md-4">
            ...
            <div  class="text-center" id="showSubBtnChemical">
                <button type="button" class="btn btn-outline-info"  > Iodine Solution  </button>
                <button type="button" class="btn btn-outline-info" id="hrefCheekCellMb" onclick="location.href='cheekcell.php';" > No Solution </button>
            </div>
            ...
            <div  class="text-center" id="showInputRangeCourse">
                <br>
                <input type="range" class="form-range" min="0" max="3" step="1" id="customRangeCourse" list="tickmarks" value="0" onchange="updateValueCourse(this.value);">
...
<script>
    ...
    document.getElementById("btnOnionCell").disabled = true;
    document.getElementById("low40x").disabled = true;
   document.getElementById("high100x").disabled = true;
    document.getElementById("hrefCheekCellMb").disabled = true;
    ...
    function showChemicalSubBtn(){
        ...
        document.getElementById('cell').style.backgroundImage="url(images/leaf40x.png)"; 
        document.getElementById("cell").style.backgroundSize = "500px 500px";
    ...
    function updateValueCourse(val) {
        ...
        //     document.getElementById('cell').style.backgroundImage="url(images/onionwithiodine10x.jpg)"; 
       ...
       if(high100X >= 1){
            ...
            document.getElementById('cell').style.backgroundImage="url(images/leaf100x.png)"; 
            document.getElementById("cell").style.backgroundSize = "500px 500px";
            document.getElementById("cell").style.backgroundSize = "cover";
            document.getElementById("cell").style.filter = "blur(5px)";
