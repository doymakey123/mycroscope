...
<div class="row">
        ...
        <br>
        <div class="col-md-4">
            <h4 style="text-align: center;"> ONION CELL IMAGE </h4>
            <h4 style="text-align: center;"> (Iodine Solution) </h4>
        ...
        <div class="col-md-4">
            ...
            <div  class="text-center" id="showSubBtnChemical">
                <button type="button" class="btn btn-outline-info" id="hrefCheekCellMb" onclick="location.href='onionwithiodinecell.php';" > Iodine Solution  </button>
   ...
   document.getElementById("high100x").disabled = true;
    ...
    function updateValueCourse(val) {
       ...
       if(low40X >= 1){
            ...
            document.getElementById('cell').style.backgroundImage="url(images/onionwithiodine40x.jpg)"; 
            document.getElementById("cell").style.backgroundSize = "100px 100px";
            document.getElementById("cell").style.backgroundSize = "cover";
            document.getElementById("cell").style.filter = "blur(5px)";
       ...
       if(high100X >= 1){
            ...
            document.getElementById('cell').style.backgroundImage="url(images/onionwithiodine100x.jpg)"; 
            document.getElementById("cell").style.backgroundSize = "100px 100px";
            document.getElementById("cell").style.backgroundSize = "cover";
            document.getElementById("cell").style.filter = "blur(5px)";
