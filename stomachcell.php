...
<div class="text-center" id="animaltypeCheekCell">
    <button class="btn btn-primary" onclick="location.href='cheekcell.php';"> Cheek Cell </button>
    <button class="btn btn-secondary"  id="btnCheekCell" onclick="location.href='stomachcell.php';" > Stomach Cell </button>
...
<div class="row">
        ...
        <br>
        <div class="col-md-4">
            <h4 style="text-align: center;"> STOMACH CELL IMAGE </h4>
        ...
        <div class="col-md-4">
            ...
            <div  class="text-center" id="showSubBtnChemical">
                <button type="button" class="btn btn-outline-info"  > Mythelene Blue  </button>
                <button type="button" class="btn btn-outline-info" id="hrefCheekCellMb" onclick="location.href='stomachcell.php';" > No Solution </button>
            </div>
...
<script>
    ...
    function showChemicalSubBtn(){
        ...
        document.getElementById('cell').style.backgroundImage="url(images/stomach10x.jpg)"; 
    ...
    function updateValueCourse(val) {
       ...
       if(low40X >= 1){
            ...
            document.getElementById('cell').style.backgroundImage="url(images/stomach40x.jpg)"; 
            document.getElementById("cell").style.backgroundSize = "100px 100px";
            document.getElementById("cell").style.backgroundSize = "cover";
            document.getElementById("cell").style.filter = "blur(5px)";
       ...
       if(high100X >= 1){
            ...
            document.getElementById('cell').style.backgroundImage="url(images/stomach100x.jpg)"; 
            document.getElementById("cell").style.backgroundSize = "100px 100px";
            document.getElementById("cell").style.backgroundSize = "cover";
            document.getElementById("cell").style.filter = "blur(5px)";
