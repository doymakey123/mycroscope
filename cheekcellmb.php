...
<div class="row">
        ...
        <div class="col-md-4">
            ...
            <h4 style="text-align: center;"> (Mythelene Blue Solution) </h4>
...
<script>
    ...
    function showChemicalSubBtn(){
        ...
        document.getElementById('cell').style.backgroundImage="url(images/cheekwithmb10x.png)"; 
    ...
    function updateValueCourse(val) {
       ...
       if(low40X >= 1){
            ...
            document.getElementById('cell').style.backgroundImage="url(images/cheekwithmb40x.png)"; 
            document.getElementById("cell").style.backgroundSize = "100px 100px";
            document.getElementById("cell").style.backgroundSize = "cover";
            document.getElementById("cell").style.filter = "blur(5px)";
